...
namespace EAuction.Seller.Product.Api.Infrastructure
{
    /// <summary>
    ...
    public static class MassTransitExtension
    {
        ...
        public static IServiceCollection AddCustomMassTransit(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddMassTransit(x =>
            {
                ...
                x.AddRequestClient<SellerProductModel>();
                x.AddRequestClient<SellerProductDeleteRequestModel>();
                x.AddRequestClient<ProductListRequestModel>();
                x.AddRequestClient<GetProductBidDetails>();
            });
